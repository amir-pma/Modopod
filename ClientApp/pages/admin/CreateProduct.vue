<template>
    <div>
        <div class="clearfix">
            <h3 class="float-left">اضافه کردن کالای جدید</h3>
            <b-button variant="link" class="float-right" to="/admin/products">برگشت به لیست کالا ها</b-button>
        </div>
        ...
        <form class="mt-4 mb-4" @submit.prevent="save">
            ...
            <b-row>
                ...
                <b-col>
                    <typeahead label="Operating system"
...
export default {
  ...
  beforeRouteEnter(to, from, next) {
    ...
    axios
      ...
      .then(
        axios.spread((filters) => {
          next(vm => vm.setData(filters.data));
        })
      );
  }
};
